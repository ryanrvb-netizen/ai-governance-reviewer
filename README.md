...
4. AI Model Governance Reviewer
...
Open the live demo
Enter basic information about an AI model used in underwriting
Toggle governance controls (human review, explainability, audit trail, etc.)
Click ‘Assess Model Risk
Review the risk rating, identified gaps, and recommended actions
